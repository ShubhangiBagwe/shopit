...
const Profile = () => {
  ...
  return (
    <div className='p-4'>
      ...
      <button onClick={() => setProfileAvatarEdit(true)} className='text-sm min-w-20 border border-[#ffc929] hover:border-[#ffbf00] hover:bg-[#ffbf00] px-3 py-1 rounded-full mt-3'>Edit</button>
